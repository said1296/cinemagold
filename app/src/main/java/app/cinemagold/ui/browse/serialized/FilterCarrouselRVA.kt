...
class FilterCarrouselRVA @Inject constructor(
    private var dataset: List<IdAndName>,
    val context: Context
) : RecyclerView.Adapter<FilterCarrouselRVA.ViewHolder>() {
